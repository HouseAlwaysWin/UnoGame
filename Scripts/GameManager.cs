...
public partial class GameManager : Node2D
{
    ...
    //         for (int i = 0; i <= 9; i++)
    //         {
    //             Deck.Add(CreateCard($"{color.ToString().ToLower()}{i}", color, CardType.Number, i));
    //             if (i == 0) continue;
    //             Deck.Add(CreateCard($"{color.ToString().ToLower()}{i}", color, CardType.Number, i));
    //         }
    ...
    //         Deck.Add(CreateCard(reverseName, color, CardType.Reverse, 10));
    //         Deck.Add(CreateCard(reverseName, color, CardType.Reverse, 10));
    //         Deck.Add(CreateCard(skipName, color, CardType.Skip, 11));
    //         Deck.Add(CreateCard(skipName, color, CardType.Skip, 11));
    //         Deck.Add(CreateCard(drawTwoName, color, CardType.DrawTwo, 12));
    //         Deck.Add(CreateCard(drawTwoName, color, CardType.DrawTwo, 12));
    //     }
    ...
    //         Deck.Add(CreateCard(wildName, CardColor.Wild, CardType.Wild, 13));
    //         Deck.Add(CreateCard(wildDrawFourName, CardColor.Wild, CardType.WildDrawFour, 14));
    //     }
    // }
    ...
    //     int count = Math.Min(Deck.Count, MaxStackSize);
    ...
    //         DeckPileNode.AddChild(visualCard);
    //     }
    // }

    // public void DisplayDeckPileWithRotation(Node2D parent, int count = 10)
    // {
    ...
    // {
    //     Player player = playerHand ?? PlayerHand;
    ...
    //     if (Deck.Count < 5) cardsToDeal = Deck.Count;
    ...
    //             else
    //             {
    //                 card.GlobalPosition = DeckPileNode.GlobalPosition;
